...
3.  **[open-goal/jak-project | GitHub](https://github.com/open-goal/jak-project)** — The core native decompiler and compiler development repository for the PC port [GitHub - open-goal/jak-project].
4.  **[In-game Settings Documentation | OpenGOAL](https://opengoal.dev/docs/usage/settings/)** — Engine-level settings detailing speedrunner mode, culling, aspect ratios, and frame rates [In-game Settings].
5.  **[Jak Speedrunning | Google Photos](https://photos.google.com)** — Community image logs and media references for movement tech [Jak Speedrunning - Google Photos].
6.  **[Language Basics | OpenGOAL](https://opengoal.dev/docs/reference/language_basics)** — Compiler mechanics, top-level expressions, and file structure basics [Language basics].
7.  **[Method System | OpenGOAL](https://opengoal.dev/docs/reference/method_system)** — Virtual method dispatching, vtables, constructor/destructor behavior, and type specialization [Method System].
8.  **[OG-Speedrun-Practice | GitHub](https://github.com/OpenGOAL-Mods/OG-Speedrun-Practice)** — Native mod reference for custom checkpoints, warp-points, and movement practice overrides [OG-Speedrun-Practice/README.md at main · OpenGOAL-Mods/OG-Speedrun-Practice · GitHub].
9.  **[Package Index | OpenGOAL](https://opengoal.dev/docs/source-docs/jak1/package-index/)** — The directory layout and physical file organization rules of `goal_src/` [Package Index].
10. **[Process and State | OpenGOAL](https://opengoal.dev/docs/reference/process_and_state)** — Low-level documentation detailing thread mechanics, process execution loops, dead pools, and state machines [Process and State].
11. **[Reader Specifications | OpenGOAL](https://opengoal.dev/docs/reference/reader)** — S-expression parser logic, integer formatting rules, and reader macros [Reader].
12. **[Standard Library | OpenGOAL](https://opengoal.dev/docs/reference/lib)** — Essential functions including `format` print escapes, block structures, lexical bindings (`let`), and basic operations [Standard library].
13. **[Symbol Index | OpenGOAL](https://opengoal.dev/docs/source-docs/jak1/symbol-index/)** — A complete index of engine symbols, states, and global variables [Symbol Index].
14. **[Syntax and Examples | OpenGOAL](https://opengoal.dev/docs/reference/syntax)** — Reference for value versus reference semantics, inline arrays, and `new` allocation behaviors [Syntax and examples].
15. **[Type System | OpenGOAL](https://opengoal.dev/docs/reference/type_system)** — Concrete specifications of the parent-child type hierarchy and compound type simplification [Type system].
